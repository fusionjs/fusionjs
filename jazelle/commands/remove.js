...
async function remove({root, cwd, name}) {
  ...
  if (local) {
    ...
    if (meta.dependencies && meta.dependencies[name]) delete meta.dependencies[name];
    if (meta.devDependencies && meta.devDependencies[name]) delete meta.devDependencies[name];
    if (meta.peerDependencies && meta.peerDependencies[name]) delete meta.peerDependencies[name];
    if (meta.optionalDependencies && meta.optionalDependencies[name]) delete meta.optionalDependencies[name];
