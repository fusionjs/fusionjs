...
test('`fusion test-app` passes', async t => {
  ...
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=passes`;
...
test('`fusion test-app` failure', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=fails`;
...
test('`fusion test-app` all passing tests', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=pass`;
...
test('`fusion test-app` expected tests fail when run in browser/node', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=fail-`;
...
test('`fusion test-app --testFolder=integration` runs correct tests', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --env=node --testFolder=__integration__`;
...
test('`fusion test-app` snapshotting', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=snapshot-no-match`;
...
test('`fusion test-app` snapshotting - enzyme serializer', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=snapshot-enzyme-no-match`;
...
test('`fusion test-app` dynamic imports', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=dynamic-imports`;
...
test('`fusion test-app` coverage', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --coverage --match=passes`;
...
test('`fusion test-app` environment variables', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --match=environment-variables`;
...
test('`fusion test-app` uses .fusionjs.js', async t => {
  ...
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js`;
...
test('`fusion test-app --debug --env=jsdom,node`', async t => {
  const dir = path.resolve(__dirname, '../fixtures/test-jest-app');
  const args = `test-app --dir=${dir} --configPath=../../../build/jest/jest-config.js --debug --env=jsdom,node  --match=passes`;
